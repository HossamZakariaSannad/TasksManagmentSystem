...
import {
  fetchInstructors,
  fetchInstructorsTrackData,
} from "../../redux/supervisorsSlice";
...
const AllCourseManagement = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchInstructors()).then(() =>
      dispatch(fetchInstructorsTrackData())
    );
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            ...
            if (fetchAvailableIntakesError && editData.trackId)
              dispatch(fetchAvailableIntakes([editData.trackId]));
          }}
          sx={{
            bgcolor: "#3b82f6",
                ...
                sortedRows.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="right" sx={{ p: 2 }}>
                      ...
                      >
                        {isDeleting &&
                        courseToDelete?.courseId === row.courseId ? (
          ...
          <FormControl variant="outlined" fullWidth sx={{ mb: 2 }}>
            ...
            <Select
              ...
              disabled={
                instructorsLoading ||
                fetchAvailableIntakesLoading ||
                !getTrackInstructors(editData.trackId).length
              }
            >
              <MenuItem value="">
                <em>Not assigned</em>
      ...
      >
        ...
        <DialogContent>
          ...
          <Typography variant="body2" sx={{ mb: 3, color: "text.secondary" }}>
            This action will also remove associated assignments and submissions
