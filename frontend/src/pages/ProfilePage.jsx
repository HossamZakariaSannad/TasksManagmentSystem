    ...
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get(
          `https://task-project-backend-1hx7.onrender.com/api/student/${studentId}/courses`,
          {
            headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(
        `https://task-project-backend-1hx7.onrender.com/api/student/${studentId}/update/`,
        {
          method: "PATCH",
          headers: {
          ...
          <Box sx={{ textAlign: { xs: "center", sm: "left" } }}>
            ...
            >
              <Chip
                ...
                size="small"
                sx={{
                  bgcolor: "rgba(25, 118, 210, 0.1)", // Semi-transparent blue
                  color: "#1976d2", // Solid blue text
          ...
          {!isEditing ? (
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  borderColor: "#1976d2", // Blood red on hover
                },
              }}
            >
              Change Password
...
const textFieldStyles = {
  "& .MuiOutlinedInput-root": {
    ...
    "&.Mui-focused fieldset": {
      borderColor: "#1976d2", // Blood red when focused
    },
  ...
  "& .MuiInputLabel-root.Mui-focused": {
    color: "#1976d2", // Blood red when focused
  },
};
